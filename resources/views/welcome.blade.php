...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="bg-[#FDFDFC] dark:bg-[#0a0a0a] text-[#1b1b18] flex p-6 lg:p-8 items-center lg:justify-center min-h-screen flex-col">
        ...
        <div class="mt-4 dark:text-white flex items-center justify-center w-full transition-opacity opacity-100 duration-750 lg:grow starting:opacity-0">
            <main class="flex max-w-[335px] w-full flex-col lg:max-w-4xl lg:flex-row">
                <div class="flex-1/2 max-w-[335px] w-full lg:max-w-4xl lg:mt-6 mt-4 leading-normal lg:leading-relaxed text-lg">
                    Welcome to <span class="font-bold">WordJozo</span>, an engaging way to dive deeper into the Bible and connect more meaningfully with <span class="font-bold">God's Word</span>. Browse any book of the Bible, open its chapters, and instantly access the full text alongside an audio player so you can listen, read, or do both. Within each chapter, you’re invited to reflect in your own words with a quick summary, helping you remember, internalize, and grow in your understanding of <span class="font-bold">God’s Word</span>. Whether you’re here to strengthen your Bible literacy, build a daily habit, or simply explore scripture in a more interactive way, <span class="font-bold">WordJozo</span> makes it easy to engage meaningfully.
                </div>
